...
BOOT_IMAGE_DEPENDENCIES = "qoriq-atf:do_deploy"
BOOT_IMAGE_DEPENDENCIES:append:ls1028ardb = " dp-firmware-cadence:do_deploy"
BOOT_IMAGE_DEPENDENCIES:append:lx2160a = " ddr-phy:do_deploy inphi:do_deploy management-complex:do_deploy mc-utils:do_deploy"
BOOT_IMAGE_DEPENDENCIES:append:ls1043ardb = " fm-ucode:do_deploy qe-ucode:do_deploy ls2-phy:do_deploy"
BOOT_IMAGE_DEPENDENCIES:append:ls1046ardb = " fm-ucode:do_deploy qe-ucode:do_deploy ls2-phy:do_deploy"
do_deploy[depends] += "virtual/kernel:do_deploy ${BOOT_IMAGE_DEPENDENCIES}"
